var html = "<div class='new_item todo_item'><table><tbody><tr><td><h3><input type='checkbox' name='complete' val='1'></h3></td><td><h3><a href='#' id='notes_link'><%= description %></a></h3></td><td><a href='/todo_items/<%= id %>/edit'>Edit</a></td><td><a id='destroy' data-method='delete' href='/todo_items/<%= id %>' rel='nofollow'>Destroy</a></td></tr></tbody></table><div class='notes_holder'><p id='notes' style='display: none'><%= notes %></p></div></div>";
